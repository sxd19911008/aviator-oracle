...
public class OracleFunctionUtilsTest {
    ...
    public void testMonthsBetweenPlus(String caseId, Instant endDate, Instant beginDate, OraDecimal expected) {
        OraDecimal actual = OracleFunctionUtils.monthsBetween(endDate, beginDate);
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testMonthsBetweenExceptions() {
        ...
        assertThrows(IllegalArgumentException.class, () -> OracleFunctionUtils.monthsBetween(now, null));
        assertThrows(IllegalArgumentException.class, () -> OracleFunctionUtils.monthsBetween(now, now.plus(1, ChronoUnit.DAYS), null));
    }
