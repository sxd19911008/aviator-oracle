...
/**
 * AviatorOracle 左移运算单元测试，对应 {@code OperatorType.SHIFT_LEFT}（即 {@code <<} 号）。
 */
@DisplayName("AviatorOracle 左移测试")
public class AviatorShiftLeftTest {
    ...
    static Stream<Arguments> testLongProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Long) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Long) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Long) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testIntegerProvider() {
        return Stream.of(
                ...
                // a(Integer) << b(BigInteger) → Long
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Integer) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Integer) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Integer) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBigIntegerProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", 3L).build(),
                        new BigInteger("16")
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigInteger) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigInteger) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigInteger) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testDoubleProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", 3L).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(Integer) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", 3).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(BigInteger) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(Double) << b(Boolean) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", true).build(),
                        ExpressionRuntimeException.class
                )
        );
    }
    ...
    static Stream<Arguments> testBigDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigDecimal) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigDecimal) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(BigDecimal) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testOraDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", 3L).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(Integer) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", 3).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(BigInteger) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", new com.eredar.aviatororacle.number.OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(Boolean) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new com.eredar.aviatororacle.number.OraDecimal("2")).put("b", true).build(),
                        ExpressionRuntimeException.class
                )
        );
    }
