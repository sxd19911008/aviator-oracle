package io.github.kentasun.aviatororacle;

import io.github.kentasun.aviatororacle.number.OraDecimal;
import io.github.kentasun.aviatororacle.testUtils.HashMapBuilder;
...
public class AviatorShiftLeftTest {
    ...
    static Stream<Arguments> testLongProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2L).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testIntegerProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBigIntegerProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("2")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testDoubleProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", 2.0).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBigDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("2")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testOraDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", 3L).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(Double) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) << b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("2")).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testInstantProvider() {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", aInstant).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBooleanProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a << b",
                        HashMapBuilder.<String, Object>builder().put("a", true).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
