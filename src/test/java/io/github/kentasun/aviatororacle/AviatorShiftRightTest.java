...
/**
 * AviatorOracle 右移运算单元测试，对应 {@code OperatorType.SHIFT_RIGHT}（即 {@code >>} 号）。
 */
@DisplayName("AviatorOracle 右移测试")
public class AviatorShiftRightTest {
    ...
    static Stream<Arguments> testLongProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", 16L).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testIntegerProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", 16).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBigIntegerProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigInteger("16")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testDoubleProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", 16.0).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testBigDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new BigDecimal("16")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
    ...
    static Stream<Arguments> testOraDecimalProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", 3L).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(Integer) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", 3).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(BigInteger) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", new BigInteger("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(Double) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", 3.0).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(BigDecimal) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", new BigDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(OraDecimal) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", new OraDecimal("3")).build(),
                        ExpressionRuntimeException.class
                ),
                ...
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", Instant.parse("2024-01-01T00:00:00Z")).build(),
                        ExpressionRuntimeException.class
                ),
                // a(OraDecimal) >> b(Boolean) → 抛出异常
                Arguments.of(
                        "a >> b",
                        HashMapBuilder.<String, Object>builder().put("a", new OraDecimal("16")).put("b", true).build(),
                        ExpressionRuntimeException.class
                )
        );
    }
