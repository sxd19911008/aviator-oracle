 ...
 * 自定义 左移 函数
 */
public class ShiftLeftFunction extends AbstractFunction {

    private static final long serialVersionUID = -8764715183192885861L;

    @Override
    public String getName() {
        return OperatorType.SHIFT_LEFT.token;
    }
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
        ...
        if (arg1.getClass() == AviatorJavaType.class) {
            ...
            // 计算
            return AOAviatorJavaType.shiftLeft(arg2, env);
        } else {
            ...
            if (arg1 instanceof AviatorNumber) {
                ...
                return aoArg1.shiftLeft(arg2, env);
            } else { // 其他场景直接计算
                return arg1.shiftLeft(arg2, env);
            }
        }
    }
}
