 ...
 * 自定义 按位或（|）运算 函数
 */
public class BitOrFunction extends AbstractFunction {

    private static final long serialVersionUID = -2183746091054382735L;

    @Override
    public String getName() {
        return OperatorType.BIT_OR.token;
    }
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
        ...
        if (arg1.getClass() == AviatorJavaType.class) {
            // 包装为 AOAviatorJavaType，其 bitOr 内部会根据实际值类型分发到对应的位运算逻辑
            AOAviatorJavaType aoArg1 = new AOAviatorJavaType(((AviatorJavaType) arg1).getName());
            return aoArg1.bitOr(arg2, env);
        } else {
