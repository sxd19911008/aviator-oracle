...
public class UnsignedShiftRightFunction extends AbstractFunction {
    ...
    public String getName() {
        return OperatorType.U_SHIFT_RIGHT.token;
    }
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
        ...
        if (arg1.getClass() == AviatorJavaType.class) {
            ...
            // 计算
            return AOAviatorJavaType.unsignedShiftRight(arg2, env);
        } else {
            ...
            if (arg1 instanceof AviatorNumber) {
                ...
                return aoArg1.unsignedShiftRight(arg2, env);
            } else { // 其他场景直接计算
                return arg1.unsignedShiftRight(arg2, env);
            }
        }
    }
}
