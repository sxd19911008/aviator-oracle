...
public class BitAndFunction extends AbstractFunction {
    ...
    private static final long serialVersionUID = 3627814509381245601L;

    @Override
    public String getName() {
        return OperatorType.BIT_AND.token;
    }
    ...
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
        ...
        if (arg1.getClass() == AviatorJavaType.class) {
            // 包装为 AOAviatorJavaType，其 bitAnd 内部会根据实际值类型分发到对应的位运算逻辑
            AOAviatorJavaType aoArg1 = new AOAviatorJavaType(((AviatorJavaType) arg1).getName());
            return aoArg1.bitAnd(arg2, env);
        } else {
